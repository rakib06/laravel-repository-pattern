...
//Repository is a layer for communicating with the controller and the data, 
...
class UserRepository implements UserInterface{
    ...
    public function getUserById($id){
        try{
            ...
            // Check the user
            if(!$user) return $this->error($e->getMessage(), $e->getCode());
    ...
    public function requestUser(UserRequest $request, $id =null){
        ...
        DB::beginTransaction();
        try{
            // If user exists then we find it to update the user
